var Navbar = React.createClass({
  render: function() {
    var showAgencies = (agency) => <AgencyNav  col={"col-sm-" + 12 / this.props.agencies.length} logo={agency.logo} name={agency.title} id={agency.id} key={agency.id} />;
    return (
      <div>
        <nav className="navbar navbar-default" id="primaryHeader">
          <div className="container-fluid">
            <div className="navbar-header">
              <a className="brand-img" href="http://sparcopen.org/">
                <svg version="1.1" id="Layer_8"   x="0px" y="0px" width="175px" height="58px" viewBox="0 0 390 80" enable-background="new 0 0 390 80" xmlSpace="preserve">
                  {/* SPARC */}
                  <g>
           ...
           14.3,27.83,14.3,19.19,0,27.58-9.88,27.58-21C58,41.06,45.13,37.24,33,34Z" />
           ...
           10.06C107,35.1,103.43,38.73,94,38.73Z" />
           ...
           2.66-2l4.64-13.42h23.48l4.37,13.13h0l0.23,0.66A2.77,2.77,0,0,0,167.81,75H181.2ZM141,48.6l8.1-23.48h0.18l7.92,23.48H141Z" />
           ...
           2.78-2.78h7.56c8.76,0,12.95,2.51,12.95,9.32C227.39,34.72,223.2,37.24,214.44,37.24Z" />
           ...
           0-31.3,11.74-31.3,35.68,0,24.32,13.32,35.87,31.3,35.87,16,0,24.19-8.22,28-20.37l0,0,0.13-.44v0a3.09,3.09,0,0,0,.06-0.56A2.81,2.81,0,0,0,307.38,52.08Z" />
                  </g>
                  {/* Asterisk */}
                  <g>
                    <path fill-rule="evenodd" className="animate" clip-rule="evenodd" d="M330.51,70.17c-0.29,0-.36-0.29-0.22-0.87l16.13-27.69-32,.22a0.58,0.58,0,0,1-.65-0.65V39.86a0.75,0.75,0,0,1,.65-0.65l32,0.22L330.29,
           ...
           0,0,1-.87-0.22L348.39,42.7,332.47,70.6c-0.29.44-.58,0.51-0.87,0.22Z" style={{fill: '#d92e35'}} />
                    <path fill-rule="evenodd" className="animate" clip-rule="evenodd" d="M332,76a5.42,5.42,0,0,1-3.21-1.06l-0.32-.19a5.21,5.21,0,0,1-2.07-1.6,5.66,5.66,0,0,1-.9-5.08l0.17-.68,12.07-20.72-23.28.16a5.54,5.54,
           ...
           5.59,0,0,1-2.48,6.78l-1.48.89-0.53.17A5.66,5.66,0,0,1,359.92,73L348.39,52.79l-11.76,20.6A5.61,5.61,0,0,1,332,76Z" style={{fill: '#d92e35'}} />
                  </g>
                </svg>
              </a>
            </div>
            <div className="navbar-header" id="navbar-header-right">
              <button type="button" className="navbar-toggle collapsed" data-toggle="collapse" data-target="#sparc-navbar-collapse-1" aria-expanded="false" aria-controls="navbar">
            ...
            <div id="sparc-navbar-collapse-1" className="navbar-collapse collapse">
              <ul className="nav navbar-nav navbar-left">
                <li> <a href="http://sparcopen.org/who-we-are/">Who We Are</a> </li>
                <li> <a href="http://sparcopen.org/what-sparc-does/">What We Do</a> </li>
                <li> <a href="http://sparcopen.org/why-open-matters/">Why It Matters</a> </li>
                <li> <a href="http://sparcopen.org/become-a-member/">Become a Member</a> </li>
              </ul>
              <ul className="social-icons list-inline pull-right">
                <li>
                  <a href="https://www.facebook.com/SPARC-155218528004623" target="_blank"> <i className="fa fa-facebook" /> </a>
                </li>
                <li>
                  <a href="https://twitter.com/SPARC_NA" target="_blank">
                    <i className="fa fa-twitter" />
                  </a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/grps?home=&gid=4184894&trk=anet_ug_hm" target="_blank">
                    <i className="fa fa-linkedin" />
                  </a>
                </li>
                <li>
                  <a href="http://sparcopen.org/contact/">
                    <i className="fa fa-envelope" />
                  </a>
                </li>
                <li>
                  <a href="http://sparcopen.org/" className="search">
        ...
        <nav className="navbar navbar-default navbar-fixed-top" id="scrolledHeader" style={{display: 'none'}}>
          <div className="container-fluid">
            <div className="navbar-header">
           ...
           5.59,0,0,1-2.48,6.78l-1.48.89-0.53.17A5.66,5.66,0,0,1,359.92,73L348.39,52.79l-11.76,20.6A5.61,5.61,0,0,1,332,76Z" style={{fill: '#d92e35'}} />
            ...
            <div id="navbar" className="navbar-collapse">
              <ul className="nav navbar-nav navbar-left navAgencies hidden-xs hidden-sm">
